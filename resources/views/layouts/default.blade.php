  ...
  <header class="bg-[#00296B]">
    <div class="container mx-auto flex justify-between items-center max-w-screen-xl py-7 items-center">
        ...
        <nav class="flex justify-between items-center gap-10 items-center text-[#4977AB]">
          <h3 class="cursor-pointer text-sm font-semibold transition duration-300 hover:text-white"><a href="{{route("home")}}">Início</a></h3>
          
          <li class="group dropdown  px-4 text-sm font-semibold cursor-pointer font-bold text-base tracking-wide list-none " >
            <a class="hover:text-white transition duration-300">Pesquisa e Licença Autoral</a>
